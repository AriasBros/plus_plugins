...
class PackageInfo {
  ...
  ///
  /// Web: The package relies on the `version.json` file generated by the build.
  ///
  /// The package tries to locate this file in the same path as the
  /// assets folder as defined Flutter loader entrypoint.
  ///
  /// If the file is not found, the package will try to use
  /// the browser window base URL to resolve the `version.json` location.
  ///
  /// Optionally, a custom version JSON URI can be provided for web.
  /// This parameter is ignored in other platforms.
